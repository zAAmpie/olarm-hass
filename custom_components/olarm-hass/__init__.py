"""
Custom integration to integrate olarm-hass with Home Assistant.

For more details about this integration, please refer to
https://github.com/zAAmpie/olarm-hass
"""
...
from .data import OlarmHassData
...
async def async_setup_entry(
    ...
    entry.runtime_data = OlarmHassData(
